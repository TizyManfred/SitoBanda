<div class="language-switcher">
    ...
    <div class="language-dropdown">
        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
            <a rel="alternate" class="language-option {{ LaravelLocalization::getCurrentLocale() === $localeCode ? 'active' : '' }}" data-locale="{{ $localeCode }}" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], $localeCode !== $defaultLocale) }}">
