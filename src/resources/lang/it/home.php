...
return [
    ...
    'hero' => [
        ...
        'slide3' => [
            ...
            'text' => 'La banda folk di Castello Tesino è una realtà che nasce nel 1901, vantando quindi più di 100 anni di storia.',
            'cta' => 'Scopri di più'
        ]
    ],
    'banner' => [
        'aria_label' => 'Comunicazione in evidenza',
        'badge' => '125 anni',
        'headline' => '125 anni di musica, storia e comunità',
        'body' => 'Festeggia con noi e scopri tutti gli appuntamenti del 125° anniversario.',
    ...
    'about' => [
        ...
        'history_text' => 'Scopri di più sulla nostra storia che nasce più di 100 anni fa',
        'members' => 'Organico',
    ...
    'events' => [
        ...
        'subtitle' => 'Scopri i nostri prossimi concerti ed eventi',
        'date' => 'Data',
        'location' => 'Luogo',
        'details' => 'Dettagli',
